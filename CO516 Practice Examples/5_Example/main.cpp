...
int main() {
  ...
  vowel = findFirstVowel("ymiru");
  cout << "The first vowel in 'ymiru' occurs at position " << vowel << endl;

  vowel = findFirstVowel("nvwls");
  cout << "The first vowel in 'nvwls' occurs at position " << vowel << endl;
  cout << endl;
